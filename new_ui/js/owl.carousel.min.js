        ...
        m = {
            ...
            e.prototype.add = function(a, b) {
                b = b === d ? this._items.length: this.normalize(b, !0),
                    ...
                    0 === this._items.length || b === this._items.length ? (this.$stage.append(a), this._items.push(a), this._mergers.push(1 * a.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1)) : (this._items[a].before(a), this._items.splice(a, 0, a), this._mergers.splice(a, 0, 1 * a.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1)),
                    this.invalidate("items"),
                    this.trigger("added", {
                        content: a,
                        position: b
